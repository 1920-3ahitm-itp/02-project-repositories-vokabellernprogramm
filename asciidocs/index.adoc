...
rectangle Vokabel-Lernprogramm {
Student -- (Erstellen eines neuen Lernsets)
Student -- (Bearbeiten der Lernsets)
Student -- (Üben der Vokabel)

(Bearbeiten der Lernsets) -- (Hinzufügen von Vokabel)
(Bearbeiten der Lernsets) -- (Löschen der Vokabel)
